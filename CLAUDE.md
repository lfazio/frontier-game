...
| Document | Authority |
| --- | --- |
| `Documentations/game-design.md` (v3.0) | **What the game does.** Normative for behaviour. Cited as `§n.m`. |
...
| `Documentations/ui-ux-admin.md` (v0.4) | **What the operator sees.** The console, its boundary and its dials.
Slices A0 and A1 built; the rest is design. Cited as `ADMIN §n`. |
