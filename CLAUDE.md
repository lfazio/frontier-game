...
| `Documentations/detailed-design-mvp.md` (v0.19) | **How the MVP is built.** Module, schema, API and algorithm
detail. Cited as `SDD §n`. |
| `Documentations/ui-ux-mvp.md` (v0.9) | **What the player sees and touches.** Screens, states, wording and
