...
| `Documentations/detailed-design-mvp.md` (v0.16) | **How the MVP is built.** Module, schema, API and algorithm
detail. Cited as `SDD §n`. |
| `Documentations/ui-ux-mvp.md` (v0.6) | **What the player sees and touches.** Screens, states, wording and
