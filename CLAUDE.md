...
| `Documentations/ui-ux-admin.md` (v0.6) | **What the operator sees.** The console, its boundary and its dials.
Slices A0 to A3 built; the rest is design. Cited as `ADMIN §n`. |
