...
| Document | Authority |
| --- | --- |
| `Documentations/game-design.md` (v2.8) | **What the game does.** Normative for behaviour. Cited as `§n.m`. |
| `Documentations/architecture.md` (v0.7) | **How it is built.** Normative for structure. Cited as `ARCH §n`. |
